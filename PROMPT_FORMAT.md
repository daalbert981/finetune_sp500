...
llm = Llama(model_path="path/to/model.gguf", n_gpu_layers=-1, n_ctx=2048)

SYSTEM_PROMPT = """This assistant is trained to code executive ranks and roles along the following categories with 1 or 0.
...
# GBNF grammar to guarantee exact output format
...
user_msg = "In 2015 the company 'hsbc finance corp' had an executive with the name kathryn madison, whose official role title was: 'chief executive officer'."
